...
<template>
  <main class="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20 lg:px-8 bg-black flex-1 w-full shadow-2xl">
    ...
    <div v-else class="text-center py-20 border border-dashed border-zinc-800 rounded-2xl light:border-zinc-300">
      <h2 class="text-xl font-bold text-white light:text-zinc-900">Project Not Found</h2>
      <p class="mt-2 text-zinc-400 light:text-zinc-650">The project you are looking for does not exist or has been moved.</p>
      <button 
        @click="goBack" 
